...
function WhatWeDo(){
    return (
        <>
            <section>
                <span className="text-white text-[1.7rem] font-bold block mt-[2rem] mb-[1.9rem] w-[16rem] mx-auto pl-[0.8rem]">What We Do</span>
                <div className="flex justify-center flex-wrap gap-[1.3rem]">
