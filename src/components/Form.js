        ...
        <>
            <section className="bg-white w-[17rem] mx-auto px-[0.4rem]">
                ...
                <form onSubmit={(e)=>e.preventDefault()}>
                    ...
                    <br />
                    <input  onChange={(e)=>setName(e.target.value)}  type="text" placeholder="Joe Smith" className="border-black border-[1px] w-[16rem] h-[2rem] pl-[0.5rem] mt-[0.4rem] mb-[0.6rem]"></input>
                    <br />
                    ...
                    <br />
                    <input  onChange={(e)=>setEmail(e.target.value)}  type="email" placeholder="example@gmail.com" className="border-black border-[1px] w-[16rem] h-[2rem] pl-[0.5rem] mt-[0.4rem] mb-[0.6rem]"></input>
                    <br />
                    
                    <label className="font-bold text-[1rem]">Phone</label>
                    <br />
                    <input  onChange={(e)=>setPhone(e.target.value)}  type="tel" placeholder="(xxx) xxx - xxxx" className="border-black border-[1px] w-[16rem] h-[2rem] pl-[0.5rem] mt-[0.4rem] mb-[0.6rem]"></input>
                    <br />
                    ...
                    <br />
                    <textarea  onChange={(e)=>setDescription(e.target.value)}  placeholder="I was looking to get a website for my company. I would be needing a checkout system ..." className="border-black border-[1px] w-[16rem] h-[9rem] pl-[0.5rem] pt-[0.5rem] mt-[0.7rem]"></textarea>
